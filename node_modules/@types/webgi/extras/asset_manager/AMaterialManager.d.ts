import { IEventDispatcher, SimpleEventDispatcher } from '../../helpers/EventDispatcher';
import { AnyOptions, IDisposable, IMaterial, IModel } from 'webgi/interfaces';
...
export interface IMaterialTemplate {
    ...
    name: string;
    materialType: string;
    generator?: (params: any, oldMaterial: any) => IMaterial;
    [id: string]: string | number | any;
}
export interface IPhysicalMaterialTemplate extends IMaterialTemplate {
    materialType: string;
}
export declare abstract class AMaterialManager<T extends string> extends SimpleEventDispatcher<T> implements IMaterialManager {
    ...
    protected _processMaterial(material: any, options: AnyOptions): IMaterial | undefined;
    processMaterial(material: IMaterial, options: AnyOptions): IMaterial;
