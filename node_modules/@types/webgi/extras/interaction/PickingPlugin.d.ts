...
import { Class, IWidget, UiObjectConfig } from 'webgi/interfaces';
...
export declare class PickingPlugin extends AViewerPlugin<'selectedObjectChanged' | 'hoverObjectChanged' | 'hitObject'> {
    ...
    autoFocus: boolean;
    setDirty(): void;
    constructor(selection?: Class<SelectionWidget> | undefined, controls?: boolean, pickUi?: boolean);
    getSelectedObject<T extends Object3D>(): T | undefined;
