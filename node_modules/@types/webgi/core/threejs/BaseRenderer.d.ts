...
export declare class BaseRenderer extends SimpleEventDispatcher<'animationLoop' | 'update' | 'resize'> implements IRenderer {
    ...
    createTarget({ sizeMultiplier, isAntialiased, encoding, type, format, depthBuffer, depthTexture, size, textureCount, ...op }?: CreateRenderTargetOptions, trackTarget?: boolean): IRenderTarget;
