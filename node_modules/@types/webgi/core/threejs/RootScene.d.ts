...
import { AddModelOptions, AnyOptions, ILight, IModel, IScene, ISceneObject, ITexture, IWidget } from 'webgi/interfaces';
...
export declare class RootScene<TCamera extends CameraController = CameraController> extends Scene implements IScene<Scene, TCamera> {
    ...
    protected _addModel(model: IModel, options?: AddModelOptions): void;
    /**
     ...
     * @returns {T}
     */
    addSceneObject<T extends ISceneObject = ISceneObject>(imported: T, options?: AnyOptions): T;
     ...
     */
    setBackground(asset: ITexture | string | number | Color | Vector4 | null): Promise<void>;
    /**
     * @warn Use {@see ViewerApp.getBackground}
     */
    getBackground(): ITexture | Color | Vector4 | null;
    get processors(): ObjectProcessorMap<'environment' | 'background'>;
    /**
     * Mark the scene dirty, and force render in the next frame.
     * @param options - set sceneUpdate to true to to mark that any object transformations have changed.
     * @returns {this<TCamera>}
     */
    ...
    dispose(): void;
    /**
     * Find objects by name exact match in the complete heirarchy.
     * @param name - name
