...
import { AnyOptions, Class, IFilter, IMaterial, ITexture, IViewerApp, IViewerPlugin, ViewerState } from 'webgi/interfaces';
...
/**
 * @licence
 * A WebGi SDK is built and maintained by Pixotronics, a license needs to be purchased from Pixotronics for any commercial use.
...
export declare class ViewerApp extends SimpleEventDispatcher<'update' | 'preRender' | 'postRender' | 'preFrame' | 'postFrame' | 'dispose' | 'addPlugin'> implements IViewerApp {
     ...
     */
    setBackgroundColor(color: string | number | Color): Promise<void>;
    /**
     ...
     * @returns {Promise<void>} - returns a promise that resolves after background is set.
     */
    setBackground(asset: ITexture | string | number | null | Vector4 | Color | EnvMapBackground): Promise<void>;
    /**
     ...
     * @param material
     */
    createPhysicalMaterial(material?: Material | MeshPhysicalMaterialParameters): IMaterial<any> | undefined;
    /**
     ...
     * @returns {this}
     */
    fromJSON(data: any, meta?: any): Promise<this>;
}
/**
