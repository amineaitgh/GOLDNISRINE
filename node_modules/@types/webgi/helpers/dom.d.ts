...
export declare function imageBitmapToBase64(bitmap: ImageBitmap | CanvasImageSource, maxWidth?: number): string;
...
export declare function getUrlQueryParam(p: string): string | null;
