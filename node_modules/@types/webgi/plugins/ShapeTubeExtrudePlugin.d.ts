...
export declare class ShapeTubeExtrudePlugin extends AViewerPlugin<''> {
    ...
    static ExtrudeShape(shape: Shape, shapeSegments: number, tubularSegments: number, tubeCurve: Curve<Vector3>, shapeScaleX: number, shapeScaleY: number, materialSplits: number[], horizontalSplits: boolean): IModel<Mesh>;
    static ConvertGeometryToFlatShape(geometry: BufferGeometry, sort?: boolean): any;
}
declare class EllipseCurve3D extends EllipseCurve {
